...
parser.add_argument('python3 obfuscate.py file.ps1', nargs='*', default=[1, 2, 3], help='')
...
███████████████████████████
    ...
    [+] Sicario just obfuscated your script. Check the current directory for the file [+] 
